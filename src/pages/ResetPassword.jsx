          ...
          <div className="p-8">
            {!loading && message ? (
              <div className="flex flex-col items-center justify-center py-8 space-y-6">
                ...
                <h2 className="text-2xl font-bold bg-gradient-to-r from-[#F36B39] to-[#000000] bg-clip-text text-transparent text-center">
                  {success
                    ? "تم إعادة تعيين كلمة المرور بنجاح"
                    : "فشل إعادة التعيين"}
                </h2>
                ...
                {success && (
                  <motion.button
                    ...
                    className="mt-4 bg-[#F36B39] text-white px-8 py-3 rounded-xl font-semibold hover:shadow-xl hover:shadow-[#F36B39]/25 transition-all duration-300 hover:bg-[#e05a2a] border border-[#F36B39]"
                  >
              ...
              <>
                <div className="text-center mb-8">
                  <h2 className="text-3xl font-bold bg-gradient-to-r from-[#F36B39] to-[#000000] bg-clip-text text-transparent">
                ...
                <form onSubmit={handleResetPassword} className="space-y-6">
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white rounded-xl pl-12 pr-12 py-4 outline-none focus:ring-2 focus:ring-[#F36B39] focus:border-transparent transition-all duration-200 group-hover:border-[#F36B39]/50"
                    />
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-600 space-y-2 transition-colors duration-300">
                    <p className="text-sm font-semibold text-[#F36B39]">
                      متطلبات كلمة المرور:
                    </p>
                  ...
                  <motion.button
                    ...
                    className={`w-full font-semibold py-4 rounded-xl transition-all duration-300 text-lg relative overflow-hidden ${
                      isFormValid
                        ? "bg-[#F36B39] text-white hover:shadow-xl hover:shadow-[#F36B39]/25 hover:bg-[#e05a2a] border border-[#F36B39]"
