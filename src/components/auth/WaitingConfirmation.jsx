  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="absolute inset-0 animate-ping rounded-full h-16 w-16 border-t-4 border-b-4 border-[#F36B39] opacity-30"></div>
      </div>
      ...
      <motion.button
        ...
        className={`w-full font-semibold py-3.5 rounded-xl transition-all duration-300 text-lg relative overflow-hidden border ${
          resendDisabled
            ...
            : "bg-[#F36B39] text-white hover:shadow-xl hover:shadow-[#F36B39]/25 border-[#F36B39] hover:bg-[#e05a2a]"
        }`}
      >
        {resendDisabled
      ...
      <button
        ...
        className="text-[#F36B39] hover:text-[#e05a2a] underline font-medium transition-colors duration-200 text-sm"
      >
